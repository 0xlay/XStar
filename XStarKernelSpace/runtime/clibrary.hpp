...
#define _C_LIBRARY_TAG_ 'BILC' 


#define getBasePointer(data_ptr) (static_cast<char*>(data_ptr) - sizeof(size_t))
#define getDataPointer(base_ptr) reinterpret_cast<char*>(base_ptr) + sizeof(size_t)
